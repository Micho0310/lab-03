...
public class MainActivity extends AppCompatActivity implements AddCityFragment.AddCityDialogListener, EditCityFragment.EditCityDialogListener {
    ...
    @Override
    public void editCity(City newCity, City oldCity) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                City oldCity = (City) adapterView.getItemAtPosition(position);
                new EditCityFragment().newInstance(oldCity).show(getSupportFragmentManager(), "Edit City");
            }
        });
